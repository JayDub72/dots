...
# --- Taps -----------------------------------------------------------------
tap "ebullient/tap"   # Required for TTRPG - which is currently not planned for use, but may be in the future 
...
# --- TTRPG / Hobby Tools ---------------------------------------------------
brew "ttrpg-convert-cli"  # Converts 5etools/pf2etools JSON into Obsidian-friendly Markdown
